...
namespace WebApp.Controllers
{
    public class FamiliesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FamilyId,FamilyValue")] Family family)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FamilyId,FamilyValue")] Family family)
        {
